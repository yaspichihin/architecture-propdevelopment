...
| 1   | Используется ли многофакторная аутентификация (MFA) для доступа к критическим системам и сервисам?                                       | Да      |    В текущей архитектуре применяется Keycloak, поддерживающий многофакторную аутентификацию (MFA). Внедрение выполнено не полностью — необходимо обеспечить обязательное применение MFA во всех критически важных системах.
          |
